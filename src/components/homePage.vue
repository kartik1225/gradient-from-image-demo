	...
	<div>
		...
		<v-card style='background: linear-gradient(to bottom, #abbaab, #ffffff) !important;'>
			...
			<v-card class='grey lighten-4'>
				...
				<v-btn @click='href("https://github.com/kartik1225/gradient-from-image")' block flat>see this project on github &nbsp; <img style='height:90%;' src='../assets/Github.png'></v-btn>
